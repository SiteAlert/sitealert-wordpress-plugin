        ...
        if ( self::should_show_three_week_upsell() ) {
			...
			if ( $screenparent == 'plugins.php' && $screen_id == 'plugins' && current_user_can( 'install_plugins' ) ) {
                ...
                <div class="updated wphc-upsell-message">
                    <p><?php esc_html_e( 'Hey there! Sorry to bother you. I noticed that you have been using WP Health for two weeks now. WP Health Premium has 
                    ...
                    <p><?php esc_html_e( 'Since you have already been using the free version, you can use coupon code TWOWEEKS to get 75% off your first month!', 'my-wp-health-check' ); ?></p>
